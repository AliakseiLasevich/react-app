...
const FacultyManager = (props) => {
    return (
        <div className={style.FacultyManager}>
            ...
            <li><NavLink activeClassName={style.active} to="/facultyManager/addFaculty">Добавить факультет</NavLink></li>
            <li><NavLink activeClassName={style.active} to="/facultyManager/allFaculties">Просмотреть все факультеты</NavLink></li>

            {/*TODO  Добавить подменю. Разобраться с вложенным роутингом*/}

            <Route path="/facultyManager/addFaculty" component={AddFaculty}/>
            <Route path="/facultyManager/allFaculties" component={AllFaculties}/>
